...
Namespace SchedulerMappedLabels
    Partial Public Class CustomAppointmentForm
        ...
        Protected Overrides Sub UpdateFormCore()
            MyBase.UpdateFormCore()
        ...
        Protected Overrides Sub edtLabel_EditValueChanged(ByVal sender As Object, ByVal e As EventArgs)
            Controller.LabelId = (TryCast(Control, CustomSchedulerControl)).CustomInnerLables.FirstOrDefault(Function(x) x.Value.Equals ( edtLabel.Label)).Key
        End Sub
    End Class
End Namespace
